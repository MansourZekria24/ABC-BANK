...
Fromid ='$id')) AS tbalance");
      ...
      $tbalance=$row["tbalance"]; 
		$_SESSION['z']=$row["tbalance"];
            ...
            if(isset($_GET["trn"]))
        {
            header("location:stransection.php");
        }
        if(isset($_GET["demo"]))
        {
            header("location:sRealbalance.php");
        }
        if(isset($_GET["tf"]))
        {
            header("location:stotaltransfer.php");
        }
           if(isset($_GET["trs"]))
        {
            header("location:stotaltra.php");
        }
...
<html lang="en">
  ...
  <body id="page-top">
   ...
   <input type="button" value="Transfer Amount" name="home"ONCLICK="window.location.href='stransfer.php' ""/>
