      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-12 text-center">
            <h2 class="section-heading">Transactions at Your Service</h2>
		...
		Withdrow:<input type="text" name="Withdrow" value=""><br><br>

		<input type="submit" name="deposit" value="Deposit"><br><br>
		<input type="submit" name="withdrow" value="Withdrow">
